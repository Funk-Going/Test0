...
os.environ['WANDB_DISABLED'] = 'true'  # 禁用W&B
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/new_data.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='NewD', help='save to project/name')
